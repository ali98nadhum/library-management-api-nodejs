...
exports.createOrderValidator = [
  ...
  exports.updateOrderValidator = [
   ...
   .withMessage("حاله الطلب يجب ان تكون 'جاري التجهيز او تم التجهيز او تم الالغاء"),

   check("deliveryStatus")
   .optional()
   .isIn(["جاري التوصيل" , "تم التوصيل" , "تم الالغاء"])
   .withMessage("حاله التوصيل يجب ان تكون جاري التوصيل او تم التوصيل او تم الالغاء"),
    VaildatorMiddleware,
  ];
